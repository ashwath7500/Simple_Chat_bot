...
conversations = open('../input/movie_conversations.txt', encoding='utf-8',errors='ignroe').read().split('\n')
#mappings lines to its id
id2line={}
for line in lines:
    _line=line.split(' +++$+++ ')
    if len(_line)==5:
...
#Seperating the questions and the answers
questions=[]
answers=[]
...
#Mapping words from questions and answers to a unique integer
threshold=20
questionswords2int={}
word_number=0
...
#Adding the tokens to the dictionaries
...
#Creating the inverse dictionary of the answerswords2int
answersints2word={w_i:w for w,w_i in answerswords2int.items()}

#Adding eos tag to the answers
for i in range(len(clean_answers)):
    clean_answers[i]+=' <EOS>'
    
#Converting the questions and answers to intergers
questions_into_int=[]
...
#Sorting questions and answers by length of the question
...
#Creating place holders for input and target
def model_input():
...
#Creating the enocder RNN layer
